...
year_segment = ['2022']
month_segment = ['1_January', '2_February']
...
start_count = start_count.groupby(['start_station_name', 'start_station_id', 'start_lat', 'start_lng']).sum().reset_index()
# end_count = end_count.groupby(['end_station_name', 'end_station_id', 'end_lat', 'end_lng']).sum().reset_index()
